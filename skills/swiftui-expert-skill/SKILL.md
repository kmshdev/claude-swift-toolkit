...
description: Write, review, or improve SwiftUI code following best practices for state management, view composition, performance, modern APIs, and Swift concurrency. Use when building new SwiftUI features, refactoring existing views, reviewing code quality, or adopting modern SwiftUI patterns.
---
...
Phase 3 (Implement — best practices) and Phase 5 (Review — checklist). Core guidelines apply during implementation; review checklist applies during code review.

## Overview
Use this skill to build, review, or improve SwiftUI features with correct state management, modern API usage, Swift concurrency best practices, and optimal view composition. Prioritize native APIs, Apple design guidance, and performance-conscious patterns. This skill focuses on facts and best practices without enforcing specific architectural patterns.
...
- Inspect Liquid Glass usage for correctness and consistency (see `apple-liquid-glass-design` skill)
...
- Improve animation patterns (use value parameter, proper transitions, see `references/animation-basics.md`, `references/animation-transitions.md`, `references/animation-advanced.md`)
...
- Apply glass effects after layout/appearance modifiers (see `apple-liquid-glass-design` skill)
...
- For Liquid Glass (iOS 26+), see the `apple-liquid-glass-design` skill
